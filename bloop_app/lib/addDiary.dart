                ...
                Align(
                  ...
                  child: Padding(
                    ...
                    child: FlatButton.icon(
                        ...
                        label: Text('Pick a date for the entry',style: TextStyle(fontSize: 20.0),),           //date picker
                        color: Colors.white,
                ...
                Padding(                                         //picking emoji
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      Row(
                          children: <Widget>[
                            AutoSizeText(' How are you feeling today? ',style: TextStyle(backgroundColor: Colors.white, fontSize: 25.0),),
                          ]
                      ),
                      Row(
                          children: <Widget>[
